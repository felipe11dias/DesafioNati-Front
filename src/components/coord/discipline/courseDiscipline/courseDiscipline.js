...
class CourseToDiscipline extends Component {
   ...
   handleSubmit = async (e) => {
      ...
      await api.post("/api/course/discipline/add", body).then( response => {
         this.props.history.push("/disciplines");
         window.location.reload();
         alert("Successfully add course to discipline");
      }).catch( Error => {
         alert("Error add course to discipline");
      });
   }
...
export default CourseToDiscipline;
